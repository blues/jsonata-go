...
var nuds = [...]nud{
	...
	typeParent:      parseParentPrefix,
	typePosition:    parsePositionPrefix,
	typeIn:          parseName,
	typeAnd:         parseName,
	typeOr:          parseName,
}
...
var leds = [...]led{
	...
	typeParent:       parseParentOperator,
	typeCrossRef:     parseCrossReferenceOperator,
	typePosition:     parsePositionOperator,
